...
```
                  ...
                  ▼                                                  ▼
  ╔═══════════════════════════════╗      ╔═══════════════════════════════════╗
  ║      MAJOR BRANCHES (8)       ║      ║       SATELLITE BRANCHES (11)     ║
  ╚═══════════════════════════════╝      ╚═══════════════════════════════════╝

  ┌──────────────┬──────────────────┐    ┌──────────────┬──────────────────┐
  │ BRANCH       │ IP ADDRESS       │    │ BRANCH       │ IP ADDRESS       │
  ├──────────────┼──────────────────┤    ├──────────────┼──────────────────┤
  │ PITX T2      │ 192.168.208.254  │    │ BACOLOD      │ 192.168.25.1     │
  │ PITX T3      │ 192.168.235.254  │    │ BATANGAS     │ 192.168.85.1     │
  │ PANGASINAN   │ 192.168.100.1    │    │ CALAMBA      │ 192.168.45.1     │
  │ BEDROCK      │ 192.168.71.1     │    │ CDO          │ 192.168.30.1     │
  │ MAKATI       │ 192.168.16.6     │    │ GENSAN       │ 192.168.20.1     │
  │ CEBU         │ 192.168.51.1     │    │ MALOLOS      │ 192.168.41.1     │
  │ DAVAO        │ 192.168.240.254  │    │ PAGADIAN     │ 192.168.60.1     │
  │ VITRO        │ 172.16.128.254   │    │ PAMPANGA     │ 192.168.35.1     │
  └──────────────┴──────────────────┘    │ TAGUM        │ 192.168.62.254   │
                                          │ ILO-ILO      │ 192.168.83.254   │
  All ports: TCP 4444 (HTTPS Console)     │ ZAMBOANGA    │ 192.168.55.1     │
                                          └──────────────┴──────────────────┘
```
